...
|---|---|---|
| Visual 2C02 netlist (Quietust) | `http://www.qmtpro.com/~nes/chipimages/visual2c02/` | segdefs.js sha256 `0322784743189ac75ba738630b97985dca507fe687a26f27333cc69ba774d87e` (4,123,728 B); transdefs.js `813ea9b73d833aa24fd3305d4734ddd378645c1a48d2c269cf9f54befa4a2471` (1,127,493 B); nodenames.js `7a6d41c271024d49544208b1507ff00bc837cc75105e03004d4a380e0bc7cd7a`. **16,758 transistors, 8,770 nodes (max index 10,905), 858 names**: 4.8x the 6502's 3,510 transistors, agreed by both real parsers (halfphi and the reference JS engine). The sketch's first draft said 16,871 from a regex that counted 114 transistors sitting inside a block comment in transdefs.js; P0's cross-parse caught it, in keeping with the family rule that instruments lie before the code does. JSSim-family format. |
